export const FailedRequestAuthLogin = {
  message: 'Erro ao fazer login. Tente novamente!',
};

export const FailedRequestAuthRegister = {
  message: 'Erro ao fazer o seu cadastro. Tente novamente!',
};

export const FailedRequestVerifyEmail = {
  message: 'Erro ao verificar se este e-mail já está cadastrado!',
};
